...
function Navigation({ textColor, textShadow }) {
    return (
        <div className={`flex text-lg justify-center py-4 ${textShadow ? "text-shadow" : "text-shadow-white"} text-${textColor}`}>
           ...
           <div className='px-5 z-50'><Link href="/faq">FAQ</Link></div> 
        </div>
    )
}
